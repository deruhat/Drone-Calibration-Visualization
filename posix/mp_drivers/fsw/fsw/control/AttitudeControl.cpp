...
#define K_WX    1			//Control gain for angular velocity about x
#define K_WY    1			//Control gain for angular velocity about y
...
Vec4 attitudeControl(Vec4 q, Mat3x3 Rdes, Mat3x3 Rbw, Vec3 w_bw, Vec3 wDes, float u1){
...
Vec4 u2pwmXshape(Vec4 u){
	...
	Rot.M[3][0] = 0; Rot.M[0][1] = 0;           Rot.M[3][2] = 0;          Rot.M[3][3] = 1;
