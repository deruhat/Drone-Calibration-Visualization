...
void* controlTask(void* threadID){
	...
	//////////////////////
// char *rosSrvrIp =  argv[1]; // = "192.168.1.51";
///////////////////////////
  //ros::NodeHandle  nh;  
  ...
  //if(argc != 2) {
    //nh.logfatal("Incorrect number of aruguments\n");
    //return -1;
  //}
  //else {
    //rosSrvrIp = argv[1];
...
//fprintf(output_file,"%f %f %f %f %f %f %f %f %f %f %f %f %f\n",t, MagFiltX.y,MagFiltY.y,MagFiltZ.y,north.v[0],north.v[1],north.v[2], RPY.v[0],RPY.v[1],RPY.v[2], w_bw.v[0], w_bw.v[1], w_bw.v[2]);
